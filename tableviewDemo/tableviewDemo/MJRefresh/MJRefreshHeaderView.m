...
- (void)setState:(MJRefreshState)state
{
	...
	switch (state) {
		...
		case MJRefreshStateRefreshing: // 正在刷新中
        {
            ...
            self.arrowImage.animationImages = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"1"],[UIImage imageNamed:@"2"], [UIImage imageNamed:@"3"], [UIImage imageNamed:@"4"], nil];
            self.arrowImage.animationDuration = 0.3;
